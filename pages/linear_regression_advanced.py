        ...
        if run_analysis and independent_vars:
            try:
                if 'W_FSTUWT' not in df.columns:
                    ...
                    results, r_squared, r_squared_adj, diagnostics, visualizations = compute_linear_regression_with_pvs(df, dependent_var, independent_vars, df['W_FSTUWT'], replicate_weight_cols, use_brr, label_to_var)
